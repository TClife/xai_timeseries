    ...
    def explain_instance(self,
       ...
       """
        ...
        permutations, predictions, distances = self.__data_labels_distances(
            ...
            num_samples, num_slices, len_ts,replacement_method)
        ...
        # prediction 5000*2 numpy, lable=int
        for label in labels:
    ...
    def __data_labels_distances(cls,
        ...
        for i, num_inactive in enumerate(deact_per_sample, start=1):
            ...
            for idx in inactive_idxs:
                ...
                elif replacement_method == 'zero_masking':
        ...
        return perturbation_matrix, predictions , distances             #perturbation 5000*num_slices, predictions 5000*2(num_class)
